<div class="l-section-five l-sec l-sec--mt l-sec--small">
    <div class="m-title m-title--products-on-sale">
        <h4><?php the_field('section_title_5', 'option', false, false); ?></h4>
    </div>
    <div class="m-flexslider m-flexslider--section-five" id="en-oferta">

        <div class="flexslider3">

            <div class="mobile-indicator" id="mobile-indicator-oferta"></div>

            <?php
            if (have_rows('slider_three', 'option')) : ?>

                <ul class="slides">

                    <?php while (have_rows('slider_three', 'option')) :
                        the_row(); ?>


                        <?php
                        $related_products = get_sub_field('product_on_sale');
                        ...
                        if ($related_products) {
                            foreach ($related_products as $product_id) {
                                ...
                                <li>
                                    <div class="m-slide m-slide--section-five">
                                        <?php
                                        ...
                                        <button class="container">
                                            ...
                                            <div class=" hover-content">AGREGAR <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 200" style="enable-background:new 0 0 200 200;" xml:space="preserve">
        ...
        <!--<div class="m-slide m-slide--section-five">
            ...
            <p class="title">Lorem ipsu.</p>
            <p class="price">$00000.00</p>
            <button>Comprar ahora</button>
        </div>-->

        <div class="custom-navigation-three cs">
            ...
            <div class="custom-controls-container-three cc"></div>
